...
<head>
	...
	<title>Dashboard - Behind the scenes</title>
...
<body>
	...
	<div class="main">
		<h2 class="text-center"><i class="fa-solid fa-image"></i><div class="d-inline bangers-regular">&nbsp Behind the scenes</div></h2>


        <center>
        <a href="dashboard-BTS-Add.php" class="btn text-white text-center border-white p-2 m-3  text-decoration-none">Add new image</a>
        </center>
    ...
    $(document).ready(function () {
      const table = $('#userTable').DataTable({
        ...
        columns: [
          ...
          { data: "timeOfUpload" },
          {
            ...
            <a class="text-danger d-inline" title="Delete"  href="dashboard-BTS-Delete.php?id=${row.id}&directory=${row.imageDirectory}"><i class="fa-solid fa-trash"></i>
            </a>

					<a class="text-success d-inline" title="Edit"  href="dashboard-BTS-Edit.php?id=${row.id}"><i class="fa-solid fa-pen-to-square"></i>
					</a>
      ...
      $('#userTable').on('click', '.deleteBtn', function () {
        ...
        if (confirm("Delete this music?")) {
          $.post('dashboard-BTS-Fetch-Delete.php', { id, imageDirectory }, function (res) {
            alert(res.message);
