...
<head>
    ...
    <title>Dashboard - Edit Event pics</title>
...
<body>
    ...
    <?php include "header.php"; ?>
     ...
     <div class="signup-container">
        <h2 class="text-center">Edit Event pics</h2>
        <form action="dashboard-Event-Edit-2.php" method="post" enctype="multipart/form-data">
