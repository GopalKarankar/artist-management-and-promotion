...
<head>
    ...
    <title>Dashboard - Add new behind the scenes pic</title>
...
<body>
    ...
    <?php include "header.php"; ?>
     ...
     <div class="signup-container">
        ...
        <h2 class="text-center">Add Behind the scenes pic</h2>
        <form action="dashboard-BTS-Add-2.php" method="post" enctype="multipart/form-data">
