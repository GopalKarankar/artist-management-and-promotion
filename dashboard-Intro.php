...
<head>
	...
	<title>Dashboard - Intro list</title>
...
<body>
	...
	<div class="main">
		<h2 class="text-center"><i class="fa-solid fa-users"></i><div class="d-inline bangers-regular">&nbsp Team intro</div></h2>
  ...
  <script>
    $(document).ready(function () {
      const table = $('#userTable').DataTable({
        ajax: "dashboard-Intro-Fetch.php",
        columns: [
          { data: "id" },
          {  data: "imageDirectory",
          ...
          { data: "uploadTime" },
          {
            ...
            <a class="text-danger d-inline" onclick="return confirmDelete()"   title="Delete"  href="dashboard-Intro-Delete.php?id=${row.id}&directory=${row.imageDirectory}"><i class="fa-solid fa-trash"></i>
            </a>

					<a class="text-success d-inline" title="Edit"  href="dashboard-Intro-Edit.php?id=${row.id}"><i class="fa-solid fa-pen-to-square"></i>
					</a>
      ...
      $('#userTable').on('click', '.deleteBtn', function () {
        ...
        if (confirm("Delete this music?")) {
          $.post('dashboard-Intro-Fetch-Delete.php', { id, imageDirectory }, function (res) {
            alert(res.message);
