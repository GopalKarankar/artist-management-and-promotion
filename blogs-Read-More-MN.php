...
<head>
    ...
    <title>Blog & News - Midwave Productions (Midwave news)</title>
             ...
             ?>
                ...
                <div class="blgs card mb-4 d-flex justify-content-center">
                    ...
                    <div class="card-body">
                        ...
                        <center><a href="blogs-Read-More.php?id=<?= $data['id'] ?>&msg=apd2mn" class="btn border-white text-white text-center">Read More</a></center>
                    </div>
...
?>
        ...
        <nav class=" d-flex justify-content-center">
            <ul class="pagination" >
                    ...
                    ?>
                        <li class="page-item">
                            <a class="page-link text-white bg-dark" href="blogs-Read-More-MN.php?pageNo=<?= $pageNo - 1 ?>&msg=apd2mn">Previous</a>
                        </li>
                    ...
                    ?>
                        <li class="page-item <?php if ($i==$pageNo) { echo "active";} ?>">
                            <a class="page-link text-white bg-dark" href="blogs-Read-More-MN.php?pageNo=<?= $i ?>&msg=apd2mn"><?= $i ?></a>
                        </li>
                    <?php
                        } 
                    ?>
                    ...
                    ?>
                        <li class="page-item">
                            <a class="page-link text-white bg-dark" href="blogs-Read-More-MN.php?pageNo=<?= $pageNo + 1 ?>&msg=apd2mn">Next</a>
                        </li>
