	...
	<div class="main">
		...
		<div class="text-center">
			<ul class="list-unstyled">
				...
				<a class="text-decoration-none d-inline px-4 py-2 apd <?php if (!empty($_GET['msg'])) { echo $_GET['msg'];	} ?>" href="dashboard-Hired-Approved.php?msg=apd2ah">Approved</a>
  ...
  <script>
    $(document).ready(function () {
      const table = $('#userTable').DataTable({
        ajax: "dashboard-Hired-Approved-Fetch.php",
        columns: [
          { data: "id" },
          { data: "fullName" },
          { data: "senderEmail" },
