...
<body>
	...
	<div class="main">
		<h2 class="text-center"><i class="fa-solid fa-guitar"></i><div class="d-inline bangers-regular">&nbsp Ticket</div></h2>
		...
		<div class="text-center">
			<ul class="list-unstyled">
				...
				<a class="text-decoration-none d-inline px-4 py-2 apd <?php if (!empty($_GET['msg'])) { echo $_GET['msg'];	} ?>" href="dashboard-Ticket-Unconfirmed.php?msg=apd2dbt">Unconfirmed</a>
  ...
  <script>
    $(document).ready(function () {
      const table = $('#userTable').DataTable({
        ajax: "dashboard-Ticket-Unconfirmed-Fetch.php",
        columns: [
          { data: "id" },
          { data: "eventID" },
          { data: "fullName" },
