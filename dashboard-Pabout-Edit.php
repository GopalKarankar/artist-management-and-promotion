...
<head>
    ...
    <title>Dashboard - Edit portfolio about</title>
...
<body>
    ...
    <?php include "header.php"; ?>
     ...
     <div class="signup-container">
        <h2 class="text-center">Edit portfolio about</h2>
        <form action="dashboard-Pabout-Edit-2.php" method="post" enctype="multipart/form-data">


            <div class="mb-3">
                <input type="hidden" name="uId" value="<?= $data['uId'] ?>" >

                <label for="bPost" class="form-label">Enter portfolio about</label>
                <textarea class="form-control" name="bPost" cols="55" rows="10"><?= $data['bPost'] ?></textarea>
            </div>
