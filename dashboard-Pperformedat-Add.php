...
<head>
    ...
    <title>Dashboard - Add places performed at</title>
...
<body>
    ...
    <?php include "header.php"; ?>
     ...
     <div class="signup-container">
        ...
        <form action="dashboard-Pperformedat-Add-2.php" method="post" enctype="multipart/form-data">


            <div class="mb-3">
                <label for="plocation" class="form-label">Enter Place performed at</label>
                <input type="text" class="form-control" id="plocation" name="plocation" placeholder="Enter place performed at"   required>
