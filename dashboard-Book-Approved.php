	...
	<div class="main">
		...
		<div class="text-center">
			<ul class="list-unstyled">
				...
				<a class="text-decoration-none d-inline px-4 py-2 apd <?php if (!empty($_GET['msg'])) { echo $_GET['msg'];	} ?>" href="dashboard-Book-Approved.php?msg=apd2dba">Approved</a>

				<a class="text-decoration-none d-inline px-4 py-2 apd " href="dashboard-Book-Disapproved.php?msg=apd2dba">Disapproved</a>
  ...
  <script>
    $(document).ready(function () {
      const table = $('#userTable').DataTable({
        ajax: "dashboard-Book-Approved-Fetch.php",
        columns: [
          { data: "id" },
          { data: "fullName" },
          { data: "senderEmail" },
      ...
      $('#userTable').on('click', '.approveBtn', function () {
        ...
        $.post('dashboard-Book-Fetch-Update.php', { id, email, status: 'Approved' }, function (res) {
          alert(res.message);
          table.ajax.reload(null, false);
        }, 'json');
      });
      ...
      $('#userTable').on('click', '.disapproveBtn', function () {
        ...
        $.post('dashboard-Book-Fetch-Update.php', { id, email, status: 'Disapproved' }, function (res) {
          alert(res.message);
          table.ajax.reload(null, false);
        }, 'json');
      });
