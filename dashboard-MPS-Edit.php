...
<head>
    ...
    <title>Dashboard - Midwave productions & studios section</title>
...
<body>
    ...
    <?php include "header.php"; ?>
     ...
     <div class="signup-container">
        ...
        <br>
        <form action="dashboard-MPS-Edit-2.php" method="post" enctype="multipart/form-data">
