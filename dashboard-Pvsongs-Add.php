...
<head>
    ...
    <title>Portfolio add video songs thumbnails</title>
...
<body>
    ...
    <?php include "header.php"; ?>
     ...
     <div class="signup-container">
        <h2 class="text-center">Add video songs from youtube iframe link</h2>
        <br>

        <form action="dashboard-Pvsongs-Add-2.php" method="post" enctype="multipart/form-data">
 
            <div class="mb-3">
                <input type="text" class="form-control" id="vLink" name="vLink" placeholder="Enter link"   required>
