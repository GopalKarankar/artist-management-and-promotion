...
<head>
    ...
    <title>Edit index section 1 Details</title>
...
<body>
    ...
    <?php include "header.php"; ?>
            ...
            <?php 
                ...
                $sql="select * from index1 where id=?";
     ...
     <div class="signup-container">
        ...
        <form action="dashboard-Index1-Edit-2.php" method="post" enctype="multipart/form-data">
