...
<head>
    ...
    <title>Dashboard - Add new Member</title>
...
<body>
    ...
    <?php include "header.php"; ?>
     ...
     <div class="signup-container">
        ...
        <form action="dashboard-Intro-Add-2.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="details" name="details" cols="8" rows="8"    required></textarea>
            </div>
