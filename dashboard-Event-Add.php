...
<head>
    ...
    <title>Dashboard - Add new event pic</title>
...
<body>
    ...
    <?php include "header.php"; ?>
     ...
     <div class="signup-container">
        <h2 class="text-center">Add events pic</h2>
        <form action="dashboard-Event-Add-2.php" method="post" enctype="multipart/form-data">
