        ...
        <div class="table-responsive">
            <table id="userTable" class="table table-bordered "   >
                ...
                <tfoot>
                    ...
                    <th><input type="text" placeholder="Search Post" /></th>
  ...
  <script>
    $(document).ready(function () {
      const table = $('#userTable').DataTable({
        ajax: "dashboard-Blogs-Fetch.php",
        columns: [
          { data: "id" },
          {  data: "imageDirectory",
          ...
          {  data: "bPost",
              render: function (data, type, row) {
                return `
                  <div class="text-center" ><a href="dashboard-Blogs-VD.php?id=${row.id}" class="btn btn-link p-0">View post</a></div>
                `;
              }
           },
          { data: "bCategory" },
              ...
              render: function (data, type, row) {
                ...
                return `
                  <div class="action-buttons-container">
                    ...
                    <a class="text-success d-inline" title="Edit"  href="dashboard-Blogs-Edit.php?id=${row.id}"><i class="fa-solid fa-pen-to-square"></i>
                    </a>
      ...
      $('#userTable').on('click', '.deleteBtn', function () {
        ...
        if (confirm("Delete this music?")) {
          $.post('dashboard-Blogs-Fetch-Delete.php', { id, imageDirectory }, function (res) {
            alert(res.message);
