...
<head>
    ...
    <title>Dashboard - Add new Brand</title>
...
<body>
    ...
    <?php include "header.php"; ?>
     ...
     <div class="signup-container">
        ...
        <form action="dashboard-Brands-Add-2.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea cols="38" rows="10" name="bDetails" id="bDetails"></textarea>
            </div>
