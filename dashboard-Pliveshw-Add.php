...
<head>
    ...
    <title>Portfolio add live show pics</title>
...
<body>
    ...
    <?php include "header.php"; ?>
     ...
     <div class="signup-container">
        <h2 class="text-center">Add live show pic</h2>


        <form action="dashboard-Pliveshw-Add-2.php" method="post" enctype="multipart/form-data">
