...
<head>
    ...
    <title>Edit Platform Details</title>
...
<body>
    ...
    <?php include "header.php"; ?>
            ...
            <?php 
                ...
                $sql="select * from pvsocial where id=?";
     ...
     <div class="signup-container">
        <h2 class="text-center">Edit Platform detaills</h2>
        <form action="dashboard-PvsocialML-Edit-2.php" method="post" enctype="multipart/form-data">
                    ...
                    <?php 
                     ...
                     ?>
                        ...
                        <input type="radio" name="logo" id='<?= $data2['logo'] ?>' value='<?= $data2['logo'] ?>'
                         <?php if ($data2['logo']==$data['logo']) { echo "checked";} ?> > 
