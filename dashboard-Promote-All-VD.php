...
<body>
	...
	<div class="main">
		<h2 class="text-center"><i class="fa-solid fa-ticket"></i>&nbsp Promotion list</h2>
		...
		<div class="text-center">
			<ul class="list-unstyled">
				...
				<a class="text-decoration-none d-inline px-4 py-2 apd " href="dashboard-Promote-Unseen.php?msg=apd2pr">Unseen</a>
			...
			<?php 
				...
				$sql="select * from promote where id=?  and  status=?";
		...
		<div class="container">
			...
			<div class="col-md-3 p-3 m-1" style="border: 1px solid white; border-radius: 10px; word-wrap: break-word; overflow-wrap: break-word; white-space: normal;">
				...
				<h5 class="">Sender Phone number: <span class="text-success font-italic"><?= $data['phone'] ?></span></h5>
				<br>

				<h5 class="">Link : <span class="text-success font-italic"><?= $data['link'] ?></span></h5>
				<br>
				...
				<p class=" text-center" >
					...
					?>
						<a class="appr btn text-success d-inline" title="Seen" href="dashboard-Promote-Seen-2.php?id=<?= $data['id'] ?>"><i class="fa-solid fa-eye"></i></a>				
					<?php
						} 
					?>
					...
					?>
						...
						<a class="btn text-danger  d-inline" title="Unseen" href="dashboard-Promote-Unseen-2.php?id=<?= $data['id'] ?>"><i class="fa-solid fa-eye-slash"></i></a>
					<?php
						} 
					?>
