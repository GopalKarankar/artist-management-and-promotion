...
<head>
	...
	<title>Dashboard - Book an event</title>
...
<body>
	...
	<div class="main">
		<h2 class="text-center"><i class="fa-solid fa-guitar"></i><div class="d-inline bangers-regular">&nbsp Book an event</div></h2>
		...
		<div class="text-center">
			<ul class="list-unstyled">
				...
				<a class="text-decoration-none d-inline px-4 py-2 apd " href="dashboard-Book-All.php?msg=apd2dba">All</a>

				<a class="text-decoration-none d-inline px-4 py-2 apd" href="dashboard-Book-Approved.php?msg=apd2dba">Approved</a>

				<a class="text-decoration-none d-inline px-4 py-2 apd <?php if (!empty($_GET['msg'])) { echo $_GET['msg'];	} ?>" href="dashboard-Book-Disapproved.php?msg=apd2dba">Disapproved</a>
		...
		<div class="table-responsive">
			<table id="userTable" class="table table-bordered "   >
			    ...
			    <tfoot>
			        ...
			        <th><input type="text" placeholder="Search Event type" /></th>
  ...
  <script>
    $(document).ready(function () {
      const table = $('#userTable').DataTable({
        ajax: "dashboard-Book-Disapproved-Fetch.php",
        columns: [
          { data: "id" },
          { data: "fullName" },
          { data: "senderEmail" },
          ...
          {  data: "details",
              render: function (data, type, row) {
                return `
                  <div><a href="dashboard-Book-All-VD.php?id=${row.id}&status=${row.status}" class="btn btn-link p-0">View Details</a></div>
                `;
              }
           },
          { data: "status" },
      ...
      $('#userTable').on('click', '.editBtn', function () {
        ...
        if (name && email) {
          $.post('dashboard-Book-Fetch-Edit.php', { id, name, email }, function (res) {
            alert(res.message);
      ...
      $('#userTable').on('click', '.deleteBtn', function () {
        ...
        if (confirm("Delete this request ?")) {
          $.post('dashboard-Book-Fetch-Delete.php', { id }, function (res) {
            alert(res.message);
            table.ajax.reload(null, false);
          }, 'json');
        }
      ...
      $('#userTable').on('click', '.approveBtn', function () {
       ...
       const email = $(this).data('email');
        ...
        $.post('dashboard-Book-Fetch-Update.php', { id, eamil,  status: 'Approved' }, function (res) {
          alert(res.message);
          table.ajax.reload(null, false);
        }, 'json');
      });
      ...
      $('#userTable').on('click', '.disapproveBtn', function () {
       ...
       const email = $(this).data('email');
        ...
        $.post('dashboard-Book-Fetch-Update.php', { id, eamil, status: 'Disapproved' }, function (res) {
          alert(res.message);
          table.ajax.reload(null, false);
        }, 'json');
      });
