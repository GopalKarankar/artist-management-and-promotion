...
<head>
    ...
    <title>Dashboard - edit Member deatails</title>
...
<body>
    ...
    <?php include "header.php"; ?>
     ...
     <div class="signup-container">
        ...
        <form action="dashboard-Intro-Edit-2.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control"  id="details" name="details" cols="54" rows="5" placeholder="Write blog post"><?= $data['details'] ?></textarea>
