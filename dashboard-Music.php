...
<head>
	...
	<title>Dashboard - Music list</title>
...
<body>
	...
	<div class="main">
		<h2 class="text-center"><i class="fa-solid fa-guitar"></i><div class="d-inline bangers-regular">&nbsp Music list</div></h2>
  ...
  <script>
    $(document).ready(function () {
      const table = $('#userTable').DataTable({
        ajax: "dashboard-Music-Fetch.php",
        columns: [
          { data: "id" },
          { data: "iframe" },
          { data: "sTitle" },
              ...
              render: function (data, type, row) {
				...
				return `
				  <div class="action-buttons-container">
					...
					<a class="text-success d-inline" title="Edit"  href="dashboard-Music-Edit.php?id=${row.id}"><i class="fa-solid fa-pen-to-square"></i>
					</a>
      ...
      $('#userTable').on('click', '.deleteBtn', function () {
        ...
        if (confirm("Delete this music?")) {
          $.post('dashboard-Music-Fetch-Delete.php', { id }, function (res) {
            alert(res.message);
