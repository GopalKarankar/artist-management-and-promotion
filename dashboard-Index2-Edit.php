...
<head>
    ...
    <title>Edit index section 2 Details</title>
...
<body>
    ...
    <?php include "header.php"; ?>
            ...
            <?php 
                ...
                $sql="select * from index2 where id=?";
     ...
     <div class="signup-container">
        ...
        <form action="dashboard-Index2-Edit-2.php" method="post" enctype="multipart/form-data">
