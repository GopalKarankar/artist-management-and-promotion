...
<head>
	...
	<title>Dashboard - Book a show</title>
...
<body>
	...
	<div class="main">
		<h2 class="text-center"><i class="fa-solid fa-ticket"></i>&nbsp Bookshow</h2>
		...
		<div class="text-center">
			...
			<?php 
				...
				$sql="select * from bookshow where id=?  and  status=?";
		...
		<div class="container">
			...
			<div class="col-md-3 p-3 m-1" style="border: 1px solid white; border-radius: 10px; word-wrap: break-word; overflow-wrap: break-word; white-space: normal;">
				...
				<br>
				<h5 class="">Event Type: <span class="text-success font-italic"><?= $data['eventType'] ?></span></h5>
				<br>
				...
				<p class=" text-center" >
					...
					?>
						<a class="appr btn text-success d-inline" title="Approve" href="dashboard-Book-Approved-2.php?id=<?= $data['id'] ?>"><i class="fa-solid fa-thumbs-up"></i></a>				
					<?php
						} 
					?>
					...
					?>
						...
						<a class="btn text-danger  d-inline" title="Disapprove" href="dashboard-Book-Disapproved-2.php?id=<?= $data['id'] ?>"><i class="fa-solid fa-thumbs-down"></i></a>
					<?php
						} 
					?>
