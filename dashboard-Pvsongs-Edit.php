...
<body>
    ...
    <?php include "header.php"; ?>
            ...
            <?php 
                ...
                $sql="select * from pvsongs where id=?";
     ...
     <div class="signup-container">
        <h2 class="text-center">Edit Video link</h2>
        <form action="dashboard-Pvsongs-Edit-2.php" method="post" enctype="multipart/form-data">
...
<!--             <div class="mb-3">
 ...
 -->
            ...
            <div class="mb-3">
                ...
                <label for="vLink" class="form-label">Youtube vLink link</label>
                <input type="text" class="form-control" id="vLink" name="vLink" value='<?= $data['vLink'] ?>'  required>
            </div>
