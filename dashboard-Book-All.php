...
<body>
	...
	<div class="main">
		<h2 class="text-center"><i class="fa-solid fa-ticket"></i><div class="d-inline bangers-regular">&nbsp Book an event</div></h2>
		...
		<div class="text-center">
			<ul class="list-unstyled">
				...
				<a class="text-decoration-none d-inline px-4 py-2 apd <?php if (!empty($_GET['msg'])) { echo $_GET['msg'];	} ?>" href="dashboard-Book-All.php?msg=apd2dba">All</a>
  ...
  <script>
    $(document).ready(function () {
      const table = $('#userTable').DataTable({
        ajax: "dashboard-Book-All-Fetch.php",
        columns: [
          { data: "id" },
          { data: "fullName" },
          { data: "senderEmail" },
