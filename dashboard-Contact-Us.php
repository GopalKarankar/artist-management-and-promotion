...
<body>
    ...
    <div class="main">
        <h2 class="text-center"><i class="fa-solid fa-address-Contact-Us"></i><div class="d-inline bangers-regular">&nbsp Contact list</div></h2>
        ...
        <div class="text-center">
            <ul class="list-unstyled">
                ...
                <a class="text-decoration-none d-inline px-4 py-2 apd <?php if (!empty($_GET['msg'])) { echo $_GET['msg'];  } ?>" href="dashboard-Contact-Us-All.php?msg=apd2cu">All</a>
  ...
  <script>
    $(document).ready(function () {
      const table = $('#userTable').DataTable({
        ajax: "dashboard-Contact-Us-Fetch.php",
        columns: [
          { data: "id" },
          { data: "name" },
          { data: "email" },
