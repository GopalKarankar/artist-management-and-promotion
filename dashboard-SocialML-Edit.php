...
<body>
    ...
    <?php include "header.php"; ?>
     ...
     <div class="signup-container">
        ...
        <form action="dashboard-SocialML-Edit-2.php" method="post" enctype="multipart/form-data">
                ...
                <h5 for="size" class="form-label">Choose logo</h5>
                    ...
                    <?php 
                     ...
                     ?>
                        ...
                        <input type="radio" name="logo" id='<?= $data2['logo'] ?>' value='<?= $data2['logo'] ?>' <?php if ($data2['logo']==$data['logo']) { echo "checked";} ?> > 
